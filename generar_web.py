...
<button type="button" class="rd-whatsapp-float" onclick="document.getElementById('rd-wa-popup').classList.toggle('activo')" aria-label="Chatear por WhatsApp con {nombre}">
...
def build_coche_html(car: dict, fotos_urls: list[str], perfil: dict) -> str:
    ...
    fotos = fotos_urls   # ya son rutas absolutas desde la raíz del dominio (ver copiar_fotos/main)
